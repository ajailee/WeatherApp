    ...
    return IntroductionScreen(
      ...
      pages: [
        ...
        PageViewModel(
          ...
          body:
              "Swipe ← Left From Home Screen To Get Weather Forecase Of The Selected City ",
        ...
        PageViewModel(
          ...
          title: "Air Pollution🏭",
          body:
              "Swipe → Right From Home Screen To See The Air Pollution Of The Selected City",
          //image: _buildImage('air.jpeg'),
          decoration: pageDecoration.copyWith(
            contentMargin: const EdgeInsets.symmetric(horizontal: 16),
            fullScreen: true,
        ...
        PageViewModel(
          title: "That's All!",
          body:
              "By The Way Dont Forget To Accept The Location📍Access Request 😜\n\n\n Developed By HD MD MI With ❤️",
